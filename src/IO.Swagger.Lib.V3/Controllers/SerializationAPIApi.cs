...
namespace IO.Swagger.Controllers
{
    ...
    public class SerializationAPIApiController : ControllerBase
    {
        ...
        public SerializationAPIApiController(IAppLogger<SerializationAPIApiController> logger, IBase64UrlDecoderService decoderService, IGenerateSerializationService serializationService)
        {
        ...
        public virtual IActionResult GenerateSerializationByIds([FromQuery] List<string> aasIds, [FromQuery] List<string> submodelIds, [FromQuery] bool? includeConceptDescriptions = false)
        {
            ...
            if (contentType.Equals("application/xml"))
            {
                ...
                var writer = XmlWriter.Create(outputBuilder, new XmlWriterSettings()
                {
                    Indent = true,
