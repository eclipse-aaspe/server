...
namespace IO.Swagger.Controllers
{
    ...
    public class AssetAdministrationShellRepositoryAPIApiController : ControllerBase
    {
        ...
        { 
            ...
            List<AssetAdministrationShell> aasList = _aasService.GetAllAssetAdministrationShells(assetIds, idShort);
        ...
        public virtual IActionResult GetAllSubmodelReferences([FromRoute][Required]string aasIdentifier, [FromQuery]int? from, [FromQuery]int? size)
        {
            ...
            List<Reference> output = _aasService.GetAllSubmodelReferencesFromAas(decodedAasIdentifier);
