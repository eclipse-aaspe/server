    ...
    public partial class Query
    {
        ...
        */
        ...
        public int CountSMs(string semanticId = "", string identifier = "", string diff = "", string expression = "")
        {
            ...
            result = query.Select("SM_Id").Count();
        ...
        // --------------- SM Methods ---------------
        public IQueryable? GetSMs(QResult qResult, Stopwatch watch, AasContext db, bool withCount = false, bool withTotalCount = false,
            string semanticId = "", string identifier = "", string diffString = "", string expression = "", string conditionSM = "", string conditionSME = "")
        {
            // parameter
