...
{ 
    ...
    { 
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SpecificAssetId: ").Append(SpecificAssetId).Append("\n");
        ...
        public bool Equals(AssetInformation other)
        {
            ...
            return 
                ...
                (
                    SpecificAssetId == other.SpecificAssetId ||
                    SpecificAssetId != null &&
                    SpecificAssetId.Equals(other.SpecificAssetId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + SpecificAssetId.GetHashCode();
