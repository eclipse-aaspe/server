...
{
    public class SubmodelServiceDB : ISubmodelService
    {
        ...
        public SubmodelServiceDB(IAppLogger<SubmodelService> logger, IAdminShellPackageEnvironmentService packageEnvService, IMetamodelVerificationService verificationService)
        {
