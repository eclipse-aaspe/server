...
{
    public class ConceptDescriptionServiceDB : IConceptDescriptionService
    {
        ...
        public ConceptDescriptionServiceDB(IAppLogger<ConceptDescriptionService> logger, IAdminShellPackageEnvironmentService packageEnvService, IMetamodelVerificationService verificationService)
        {
