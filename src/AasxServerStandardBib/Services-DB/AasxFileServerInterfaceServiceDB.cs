...
{
    public class AasxFileServerInterfaceServiceDB : IAasxFileServerInterfaceService
    {
        ...
        public AasxFileServerInterfaceServiceDB(IAppLogger<AasxFileServerInterfaceService> logger)
        {
            _logger = logger;
