                        ...
                        if (smeSearchTimeStamp.Count != 0)
                        {
                            ...
                            foreach (var sme in smeSearchTimeStamp)
                            {
                                ...
                                */
                                ...
                                Console.WriteLine($"Event {entry.eventPayloadEntryType.ToString()} Schema: {entry.dataschema} idShortPath: {entry.subject.idShortPath}");
                                countSME++;
                            }
                        }
                    }
        ...
        foreach (var input in op.InputVariables)
        {
            ...
            switch (inputRef.IdShort.ToLower())
            {
                ...
                case "endpoint":
                    ...
                    break;
                //ToDo: Will be phased out in favour of withPayload
                case "nopayload":
                    if (p != null)
