...
namespace IO.Swagger.Registry.Lib.V3.Models
{
    ...
    public partial class SubmodelDescriptor : Descriptor, IEquatable<SubmodelDescriptor>
    {
        ...
        public SubmodelDescriptor(AdministrativeInformation administration = null, List<Endpoint> endpoints = null, string idShort = null, string id = null, Reference semanticId = null, List<Reference> supplementalSemanticId = null, List<string> federatedElements = null)
        {
            ...
            FederatedElements = federatedElements;
        }
