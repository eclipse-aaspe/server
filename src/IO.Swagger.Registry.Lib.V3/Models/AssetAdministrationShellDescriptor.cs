...
namespace IO.Swagger.Registry.Lib.V3.Models
{
    ...
    public partial class AssetAdministrationShellDescriptor : Descriptor, IEquatable<AssetAdministrationShellDescriptor>
    {
        ...
        public AssetAdministrationShellDescriptor(AdministrativeInformation administration = null, AssetKind assetKind = AssetKind.NotApplicable, string assetType = null, List<Endpoint> endpoints = null, string globalAssetId = null, string idShort = null, string id = null, List<SpecificAssetId> specificAssetIds = null, List<SubmodelDescriptor> submodelDescriptors = null)
        {
