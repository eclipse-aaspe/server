...
namespace IO.Swagger.Registry.Lib.V3.Models
{
    ...
    public partial class ProtocolInformation : IEquatable<ProtocolInformation>
    {
        ...
        public ProtocolInformation(string href = null, string endpointProtocol = null, List<string> endpointProtocolVersion = null, string subprotocol = null, string subprotocolBody = null, string subprotocolBodyEncoding = null, List<ProtocolInformationSecurityAttributes> securityAttributes = null)
        {
            Href = href;
