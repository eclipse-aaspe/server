# Branch: magnus-redeker/itsOWL-TeDZ_restServerUpdates
...
in new branch
  ...
  magnus-redeker/itsOWL-TeDZ_restServerUpdates
...
* updated submodels and submodelElements are replaced so that their ordering does not change (before: existing submodels/submodelElements were removed and their update was added to the end of the collection)
